    ...
    <div className="space-y-6">
      ...
      <GlassPanel>
        ...
        <form onSubmit={submitExamPreference} className="mt-5 grid gap-4 sm:grid-cols-3">
          <select value={discipline} onChange={(e) => setDiscipline(e.target.value)} className="rounded-xl border border-white/10 bg-slate-950/70 px-4 py-3 text-white"><option value="عمران">عمران</option><option value="معماری">معماری</option><option value="تأسیسات مکانیکی">تأسیسات مکانیکی</option><option value="تأسیسات برقی">تأسیسات برقی</option><option value="ترافیک">ترافیک</option><option value="نقشه‌برداری">نقشه‌برداری</option><option value="شهرسازی">شهرسازی</option></select>
          <select value={qualification} onChange={(e) => setQualification(e.target.value)} className="rounded-xl border border-white/10 bg-slate-950/70 px-4 py-3 text-white"><option value="نظارت">نظارت</option><option value="اجرا">اجرا</option><option value="محاسبات">محاسبات</option><option value="طراحی">طراحی</option><option value="بهسازی">ارزیابی، طرح و اجرای بهسازی</option><option value="گود، پی و سازه نگهبان">طرح و اجرای گود، پی و سازه نگهبان</option><option value="عمومی">رشته بدون صلاحیت تفکیک‌شده</option></select>
